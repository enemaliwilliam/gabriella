        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('client.update',['id' => $client->id ]) }}">
                        ...
                        <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="date_of_birth" type="date" class="form-control" name="date_of_birth" value="{{$client->date_of_birth}}">
                        ...
                        <div class="form-group{{ $errors->has('mobile_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_number" type="text" class="form-control" name="mobile_number" value="{{$client->mobile_number}}">
                        ...
                        <div class="form-group{{ $errors->has('is_pregnant') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="is_pregnant" value="1" type="checkbox" class="form-control" name="is_pregnant" value="{{$client->is_pregnant}}">
                        ...
                        <div class="form-group{{ $errors->has('weeks') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="weeks" type="number" class="form-control" name="weeks" value="{{$client->weeks}}">
                        ...
                        <div class="form-group{{ $errors->has('emmergency_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="emmergency_number" type="text" class="form-control" name="emmergency_number" value="{{$client->emmergency_number}}">
